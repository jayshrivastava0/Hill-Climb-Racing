...
class window_capture:
    ...
    def start_capture(self):
        ...
        try:
            ...
            # Threshold the image based on HSV values from the dictionary
            # frame_threshold = cv2.inRange(img_hsv, (hsv_values['low_H'], hsv_values['low_S'], hsv_values['low_V']),
            #                           (hsv_values['high_H'], hsv_values['high_S'], hsv_values['high_V']))
